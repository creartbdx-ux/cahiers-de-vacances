/**
 * Deterministic seeded pseudo-random generator shared by all technical engines.
 *
 * Engines NEVER call Math.random(). All randomness flows through a seeded
 * PRNG so the same input + same seed always produce exactly the same grid.
